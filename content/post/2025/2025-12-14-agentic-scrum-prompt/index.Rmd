...
5. テストを通す最小限のコードを書く
6. コミット: "feat: {実装の説明}"
7. status = "refactoring" に変更
8. 必要に応じてリファクタリング（各改善ごとにコミット）
9. status = "completed" に変更
10. ダッシュボードを更新
```
...
- Sprint Retrospective終了時
- ダッシュボードが300行を超えたとき（目安: Product Goal 10行 + PBI 20件 x 10行 + Sprint 20行 + DoD 10行 + Completed 30行 + Retrospectives 30行）
