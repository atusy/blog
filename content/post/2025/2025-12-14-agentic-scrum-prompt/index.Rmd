...
```
Refinement -> Planning -> Execution -> Review -> Retro -> scrum.yaml compaction -> (Next Refinement)
```
...
retrospectives:
  - sprint: 1
    improvements:
      - action: "改善アクション"
        timing: sprint  # immediate | sprint | product
...
| プロセス調整 | scrum.yamlへのメモ追加、DoD更新、PBIテンプレート改善 | immediate |
