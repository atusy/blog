...
- **Independent**: 他のストーリーから独立して開発・デリバリー可能
- **Negotiable**: 詳細は交渉可能、解決策でなく成果に焦点
- **Valuable**: 明確なビジネス価値がある
- **Estimable**: 見積もり可能（大きな不明点がない）
- **Small**: AIエージェントにとって「Small」は時間の観点ではなく、**これ以上分割するとユーザー価値を失う最小単位**を意味する。1スプリント1PBIの原則により、できるだけ小さく分割することでフィードバックサイクルを増やせる
- **Testable**: 具体的で測定可能な受け入れ基準がある
