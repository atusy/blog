...
treesitter-lsは**kakehashi**に解明しました。詳しくは以下の記事をご覧ください。

> [🌉 kakehashiよ、あらゆるエディタ・言語の架け橋になれ！コードブロック内の補完や定義ジャンプ、任意言語のシンタックスハイライトとか欲しかったやつうううう！を実現するぞ](https://blog.atusy.net/2026/01/01/kakehashi/)
