...
RStudio IDEを開発するPosit PBCが[Table Contest: 2024 Edition]を開催しています。
...
あと、今回が初の挑戦となったことに、[shinyapps.io]を使ったShinyアプリケーションの公開があります。
...
[Table Contest: 2024 Edition]: https://posit.co/blog/announcing-the-2024-table-contest/
