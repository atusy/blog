...
[This Week in Neovim](https://this-week-in-neovim.org)という、週次でNeovim関係のニュースを届けてくれるウェブサイトの[21 Nov 2022号](https://this-week-in-neovim.org/2022/Nov/21)で、プラグインの[folke/styler.nvim](https://github.com/styler.nvim)が紹介されていました。
...
vim.api.nvim_create_autocmd(
  'BufRead', -- Neovim内でCWDを変えるケースがあるなら'BufEnter'もアリ
  {
